...
`./cli/haven backup platform --now` uses this method so a misconfigured object store does not fail the request silently.

---

## Related

- [Production overlay](production-overlay.md)
- [CLI → backup](cli.md#backup)
