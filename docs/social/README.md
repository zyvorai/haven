...
|---|---|---|
| `haven-share-card.png` | 1200×630 card: the README hero and Open Graph preview | `./docs/social/build-social-card.sh` |
| `haven-social-card.html` / `.jpg` | 1600×900 (16:9) card for LinkedIn and X: the identity-plane story in five steps | same script |
| `haven-share-card.html` | Source for the 1200×630 share card | same script |
